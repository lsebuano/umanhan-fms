        ...
        public FarmTransactionValidator()
        {
            ...
            RuleFor(x => x.UnitPrice)
                ...
                .When(x => x.TransactionType != null && 
                           x.TransactionType.Equals(Models.TransactionType.SALE.ToString(), StringComparison.OrdinalIgnoreCase));
            ...
            RuleFor(x => x.BuyerId)
                ...
                .When(x => x.TransactionType != null &&
                           x.TransactionType.Equals(Models.TransactionType.DONATION.ToString(), StringComparison.OrdinalIgnoreCase));
